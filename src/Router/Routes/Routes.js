...
const Routes = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://vehicles-zone-server.vercel.app/categories/${params.id}`)
            },
            {
                path: "/signup",
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://vehicles-zone-server.vercel.app/orders/${params.id}`)
            }
        ]
    },
    {
