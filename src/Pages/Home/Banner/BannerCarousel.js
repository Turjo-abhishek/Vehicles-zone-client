  ...
  return (
    <div id={`slide${id}`} className="carousel-item relative w-full">
      ...
      <div className="absolute flex justify-end transform -translate-y-1/2 gap-3 left-24 lg:left-44 top-1/3">
        <h1 className="text-white font-bold leading-none text-2xl lg:text-6xl">
           Buy your dream car<br /> With Vehicle's <br /> Zone
        </h1>
      </div>
      <div className="absolute flex justify-end transform -translate-y-1/2 gap-3 w-2/5 left-24 lg:left-44 top-2/4 mt-10 lg:mt-8">
